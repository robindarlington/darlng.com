...
- [ ] **HERO-01**: Cinematic full-bleed hero featuring the latest release (*Eseriani*, 2026) with artwork, release title, and primary streaming CTAs (Spotify, Apple Music, YouTube)
...
- [ ] **LISTEN-01**: Native, fully-branded "listen everywhere" page with per-platform buttons (Spotify, Apple Music, YouTube/YouTube Music, Tidal, Amazon Music, Deezer, SoundCloud) for the latest release plus catalog access — no third-party smart link
...
| HERO-01 | TBD | Pending |
| HERO-02 | TBD | Pending |
| MUSIC-01 | TBD | Pending |
| MUSIC-02 | TBD | Pending |
...
- Unmapped: 20 ⚠️ (roadmapper will resolve)
